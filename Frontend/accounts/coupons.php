...
<body class="accounts-bg">
    ...
    <main class="orders-section account-main-content" style="flex:1;">
        <div class="orders-header">
            <div class="orders-title">Coupons & Offers</div>
            <div class="orders-filter">
                <span>Coupons in:</span>
        ...
        <div style="background:#fff;border:1px dashed #ccc;border-radius:6px;padding:18px 18px 14px 18px;max-width:900px;margin-top:10px;">
